...
def run_epoch(model, loader, zero_norm, get_labels_fn, training, optimizer=None, global_step=0):
    ...
    if training:
        ...
        calib_start_step, _ = get_evt_step_range()
            ...
            if training:
                ...
                with torch.no_grad():
                    ...
                    for t in range(max_rollout):
                        ...
                        if fixed_target == -1 and prev_err_per_sample is not None and t >= calib_start_step:
                            ...
                            if curr_score is not None:
                                ...
                                if curr_score > current_evt_score_threshold:
                                    target_N = t - 1
                                    break
                            else:
